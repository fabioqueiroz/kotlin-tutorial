...
import com.fq.navigationtutorial.databinding.FragmentFirstBlankBinding
...
class FirstBlankFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(myModel!=null)
        {
            myModel.name = "Test from Kotlin"
            myModel.age = 1234
        }

        binding.soundsButton.setOnClickListener {
            navController.navigate(R.id.action_firstBlankFragment_to_soundsFragment)
        }
        
        binding.surveyButton.setOnClickListener {
            navController.navigate(R.id.action_firstBlankFragment_to_surveyFragment)
        }
